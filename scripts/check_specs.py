...
def main():
    ...
    for path in (ROOT/'docs/diagrams').glob('*.excalidraw'):
    ...
    print(f'Local structural checks passed: {count} requirements and 3 editable scenes. Official OpenSpec CLI validation is separate.')
