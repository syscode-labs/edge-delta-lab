...
|---|---:|---:|---:|
| cold-sigkill-and-resume | 17,089,252 | 53,581 | 30.426 |
| second-image-shared-base | 6,819,307 | 54,877 | 11.442 |
| small-edit-in-large-layer | 249,778 | 53,581 | 0.643 |
| unchanged-repeat | 0 | 0 | 0.080 |
| inserted-bytes-resynchronize | 253,874 | 53,581 | 0.628 |
| skip-v1-directly-to-v3 | 262,066 | 53,581 | 0.681 |
| repair-one-corrupt-cache-chunk | 76,731 | 0 | 0.213 |

Verified chunks preserved across SIGKILL: 8; re-requested: 0.
